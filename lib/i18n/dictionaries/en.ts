...
const en: Dictionary = {
    ...
    clients: {
        ...
        addSubmit: "Add client",
        editTitle: "Edit client",
        editSubmit: "Save changes",
        detail: {
            title: "Client detail",
            notFound: "This client doesn't exist...",
            locality: "Locality",
        ...
        deleteModal: {
            title: "Move to trash",
            text: "This client will be moved to the trash. You'll be able to restore it from there if needed.",
            bulkText: "Move {count} client(s) to the trash? You'll be able to restore them from there if needed.",
            deleting: "Deleting…",
        ...
        trash: {
            ...
            deleteForeverText: "Permanently delete « {name} »? This action is irreversible, their photo will also be deleted.",
        },
        activity: {
            title: "Activity log",
            backToClients: "Back to clients",
        ...
        import: {
            ...
            introSuffix: "(Firstname, Lastname, Email, Company, Phone, Website, Status, Address, City, Zip Code, Country). Emails that already exist will be flagged as errors rather than overwritten.",
    ...
    projects: {
        ...
        list: {
            ...
            activity: "Activity",
            startPrefix: "Start: ",
            searchPlaceholder: "Search a project or client…",
            ...
            openClientHint: "Open a client's page to add a project for them.",
        },
        fields: {
            name: "Project name",
            type: "Project type",
        ...
        import: {
            ...
            introSuffix: "(Name, Client Email, Type, Status, Power, Budget, Address, Start Date, End Date, Notes). Each row is matched to an existing client by email.",
            chooseFile: "Choose a CSV file (same columns as the export)",
            importing: "Importing…",
            submit: "Import",
            rowLabel: "Row {row}",
        ...
        messages: {
            ...
            invalidRow: "Invalid row.",
            unknownClientEmail: "No client matches this email.",
        },
    },
    tasks: {
