...
const en: Dictionary = {
    ...
    portal: {
        ...
        admin: {
            ...
            resetLinkHint: "Send this link to the contact so they can set their password (valid for 24 hours):",
            copyLink: "Copy link",
            copied: "Link copied",
        },
    },
    ...
    accessDenied: {
        title: "Access denied",
        message: "You don't have access to any area. Contact your administrator.",
    },
    photoUpload: {
    ...
    projects: {
        ...
        detail: {
            ...
            notes: "Notes",
            tasksHeading: "Tasks",
            tasksDescription: "Task progress and material stock, updated from delivery notes.",
            ...
            interventionsDescription: "Scheduled site visits, with technician and status.",
            ...
            reservesDescription: "Defects logged on the drawings, tracked through to resolution.",
    ...
    materials: {
        ...
        linkedTaskTasksGroup: "Tasks",
        linkedTaskSeriesGroup: "Series",
        linkedTaskCategoriesGroup: "Groups",
    ...
    reserves: {
        ...
        addPlanSubmit: "Add plan",
        noPlans: "No plan yet. Add a PDF plan to start dropping snags.",
        planSelectLabel: "Plan",
        deletePlan: "Delete plan “{name}”",
        deletePlanText: "Delete “{name}” and all its snags? This action is irreversible.",
        addHint: "Click on the plan to add a snag.",
        reserveCount: "{count} snag(s)",
        // Snag status counters — see fr.ts's own comment (arbitrage, PR #196).
        ...
        numberLabel: "#{number}",
        noReserves: "No snags.",
        noReservesWithLabel: "No {label} snags.",
        status: {
            OPEN: "Open",
            RESOLVED: "Resolved",
        },
        statusLabel: "Status",
        descriptionLabel: "Description",
        descriptionPlaceholder: "Describe the snag…",
        ...
        newReserveTitle: "New snag",
        editReserveTitle: "Snag",
        deleteReserve: "Delete snag",
        deleteReserveText: "Delete this snag? This action is irreversible.",
        save: "Save",
        add: "Add",
        ...
        photoAlt: "Photo {index} of snag #{number}",
        photosAfterSave: "Save the snag first to attach photos to it.",
        ...
        report: {
            ...
            total: "Total",
            noReserves: "No snags on this plan.",
        ...
        // button in the Snags section header itself.
        statusStyle: {
            configureButton: "Settings",
            modalTitle: "Snag statuses",
    ...
    jobFunctions: {
        ...
        scope: {
            title: "Project scope",
            hint: "Which projects users with this function may reach. Filtering happens in the query: a project out of scope is not found, direct URL included.",
            all: "Every project",
        ...
        access: {
            ...
            capabilities: {
                "content.edit": {
                    ...
                    description: "Companies, projects, tasks, materials, snags…",
                },
                "content.trash": {
                    label: "Trash",
