export default function ClientDetailLoading() {
  return (
    <main className="flex flex-1 min-h-0 flex-col overflow-y-auto px-6 py-8">
      <div className="w-full max-w-xl mx-auto overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 shadow-sm">
        ...
        <div className="px-4 py-2 sm:px-6">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex items-center gap-3 border-b border-gray-300 dark:border-gray-700 py-4 last:border-b-0">
        ...
        <div className="flex gap-2.5 border-t border-gray-300 dark:border-gray-700 bg-gray-200 dark:bg-gray-900 px-4 py-4 sm:px-6">
          <div className="h-9 w-28 animate-pulse rounded bg-gray-300 dark:bg-gray-700" />
          <div className="h-9 w-28 animate-pulse rounded bg-gray-300 dark:bg-gray-700" />
        </div>
      </div>
    </main>
