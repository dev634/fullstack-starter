          ...
          <dl className="px-4 py-2 sm:px-6">
            {project.power != null && (
              <div className="flex items-center gap-3 border-b border-gray-200 dark:border-gray-700 py-3 last:border-b-0">
                ...
                <dt className="w-24 shrink-0 text-sm text-gray-500 dark:text-gray-400">Puissance</dt>
            ...
            {project.budget != null && (
              <div className="flex items-center gap-3 border-b border-gray-200 dark:border-gray-700 py-3 last:border-b-0">
                ...
                <dt className="w-24 shrink-0 text-sm text-gray-500 dark:text-gray-400">Budget</dt>
                <dd className="min-w-0 text-sm">{project.budget.toLocaleString("fr-FR")} €</dd>
              </div>
            )}
            {project.address && (
              <div className="flex items-center gap-3 border-b border-gray-200 dark:border-gray-700 py-3 last:border-b-0">
                <MapPinIcon className="h-5 w-5 shrink-0 text-gray-400 dark:text-gray-500" />
                <dt className="w-24 shrink-0 text-sm text-gray-500 dark:text-gray-400">Adresse</dt>
            ...
            {(project.startDate || project.endDate) && (
              <div className="flex items-center gap-3 border-b border-gray-200 dark:border-gray-700 py-3 last:border-b-0">
                ...
                <dt className="w-24 shrink-0 text-sm text-gray-500 dark:text-gray-400">Dates</dt>
            ...
            {project.notes && (
              <div className="flex items-start gap-3 py-3">
                <dt className="w-24 shrink-0 text-sm text-gray-500 dark:text-gray-400">Notes</dt>
