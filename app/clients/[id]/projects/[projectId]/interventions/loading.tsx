// Route-level skeleton for the Interventions section's own page. Without
// this file the segment would inherit
...
// page's title row + single card (header, intervention rows).
export default function ProjectInterventionsLoading() {
  return (
    <main className="flex flex-1 min-h-0 flex-col overflow-y-auto px-6 py-8">
      <div className="w-full max-w-3xl mx-auto space-y-6">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700 bg-[#f3f4f6] dark:bg-[#1f2937] shadow-sm">
          {/* Header: section title + count, add-intervention button */}
